...
* **Patch and minor** versions are always compatible, for example any 4.0.1 component will
work with any 4.0.3 component and 5.1.0 component will work with any 5.7.0 component.

* Major versions are always compatible with the **previous** major release. This
  means you must not attempt to upgrade from 3.x.x straight to 5.x.x. You must
  upgrade to 4.x.x first.
